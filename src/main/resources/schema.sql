...
drop sequence if exists DB_INFO_SEQUENCE ;
...
CREATE SEQUENCE IF NOT EXISTS DB_INFO_SEQUENCE START WITH 10 INCREMENT BY 1;
...
(
    ...
    DB_INFO_ID INTEGER REFERENCES DB_INFO(ID),
